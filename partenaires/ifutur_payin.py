...
class ifuturPayinProcessor:
    ...
    def process(self):
        ...
        match_key_partner = self.match_col_partner or 'external_reference'
        # traitement  pour PMT
        ...
        correspondance_operator = dfop_unique.set_index(match_key_partner)['payment_method']
        correspondance_amount = dfop_unique.set_index(match_key_partner)['Net']
        # Utilisation de map pour ajouter les colonnes correspondantes à dfpmt
        dfpmt['Amountop'] = dfpmt[match_key_pmt].map(correspondance_amount)
...
# ================================
        ...
        # Création du tableau croisé dynamique
            ...
            maj_failed_a_succes = dfpmt.loc[(dfpmt['Statut'] != 'SUCCESS') & (dfpmt['IFUTUR'] == 1)]
