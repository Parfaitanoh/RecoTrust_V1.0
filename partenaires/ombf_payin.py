...
class OmbfPayinProcessor:
    ...
    def process(self):
        ...
        match_key_pmt = self.match_col_pmt or 'Transaction ID' or 'id_operator ' or 'id_operator'
        match_key_partner = self.match_col_partner or 'FTXN_ID' or 'TRANSFER_ID'
        ...
        def remak(x):
            parts=x.split(' ')
            return parts[0]
        dfop['DATE']=dfop['TRANSFER_ID'].apply(remak)
...
# ================================
        ...
        with tabs[1]:
            ...
            maj=df_filteredpmt[(df_filteredpmt['Statut']!='SUCCESS')]
        ...
        # Création du tableau croisé dynamique
            ...
            maj_failed_a_succes = dfpmt[(dfpmt['Statut'] == 'FAILED') & (dfpmt['OMBF'] == 1)]
